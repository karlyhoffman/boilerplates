...
(function ($, window, document, undefined) {
  ...
  $(function () {
    ...
    $(".reveal").each(function (index, elem) {
      var revealIn = TweenMax.fromTo(_this, 0.4, { "opacity": "0", marginTop: 40 }, { "opacity": "1", marginTop: 0, ease: Power0.easeNone });
      var revealScene = new ScrollMagic.Scene({ triggerHook: "0.72", triggerElement: _this }).setTween(revealIn).addTo(controller);
    });

    $(".fade").each(function (index, elem) {
      var fadeIn = TweenMax.fromTo(_this, 0.5, { "opacity": "0" }, { "opacity": "1", ease: Power0.easeNone });
      var fadeScene = new ScrollMagic.Scene({ triggerHook: "0.95", triggerElement: _this }).setTween(fadeIn).addTo(controller);
    });
    ...
    $(".reveal-stagger").each(function (index, elem) {
      ...
      var revealStaggerScene = new ScrollMagic.Scene({ triggerHook: "0.75", triggerElement: _this }).setTween(fadeStaggerIn).addTo(controller);
    });
